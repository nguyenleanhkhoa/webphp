...
<head>
	...
	<meta name="keywords" content="Yến sào gia bảo" />
	<script>
	...
	<!--//tags -->
	<link href="{{ URL::asset('source/css/bootstrap.css') }}" rel="stylesheet" type="text/css" media="all" />
	<link href="{{URL::asset('source/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
	<link href="{{URL::asset('source/css/font-awesome.css')}}" rel="stylesheet">
	<!--pop-up-box-->
	<link href="{{URL::asset('source/css/popuo-box.css')}}" rel="stylesheet" type="text/css" media="all" />
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="{{URL::asset('source/css/jquery-ui1.css')}}">
	<!-- flexslider -->
	<link rel="stylesheet" href="{{URL::asset('source/css/flexslider.css')}}" type="text/css" media="screen" />
	<!-- fonts -->
...
<body>
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> 0937808578
					</li>
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="dropdown">
									<a href="#" class="dropdown-toggle nav-stylehead" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Công dụng với cách chế biến
	...
	<div class="banner-bootom-w3-agileits">
		<div class="container">
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb={{URL::asset("source/images/toyennguyenchat/{$ctsanpham->image}")}}>
								<div class="thumb-image">
									<img src={{URL::asset("source/images/toyennguyenchat/{$ctsanpham->image}")}} data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
			...
			<div class="col-md-7 single-right-left simpleCart_shelfItem">
				...
				<p>
					<span class="item_price">{{number_format($ctsanpham->promotion_price)}}</span>
					<del>{{number_format($ctsanpham->unit_price)}}</del>
					<label>Ship free</label>
				</p>
				<div class="single-infoagile">
					<ul>
						<li>
							 Thanh toán trên Delivery Eligible.
						</li>
						<li>
				...
				<div class="product-single-w3l">
					<p>
						...
						<label>functional foods</label> product.</p>
					<ul>
						<li>
							{{$ctsanpham->description}}
						</li>

					</ul>
					<p>
						<i class="fa fa-refresh" aria-hidden="true"></i>Tất cả các sản phẩm
						<label>miễn đổi trả.</label>
					</p>
				</div>
					...
					<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
						<form action="#" method="post">
							<fieldset>
								...
								<input type="hidden" name="item_name" value="{{number_format($ctsanpham->promotion_price)}}" />
								<input type="hidden" name="amount" value="{{number_format($ctsanpham->unit_price)}}" />
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src={{ URL::asset('source/js/jquery-2.1.4.min.js') }} ></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src={{ URL::asset('source/js/jquery.magnific-popup.js') }} ></script>
	<script>
	...
	<!-- cart-js -->
	<script src={{URL::asset('source/js/minicart.js')}}></script>
	<script>
	...
	<!-- smoothscroll -->
	<script src={{URL::asset('source/js/SmoothScroll.min.js')}}></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src={{URL::asset('source/js/move-top.js')}}></script>
	<script src={{URL::asset('source/js/easing.js')}}></script>
	<script>
	...
	<!-- imagezoom -->
	<script src={{URL::asset('source/js/imagezoom.js')}}></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src={{URL::asset('source/js/jquery.flexslider.js')}}></script>
	<script>
	...
	<script src={{URL::asset('source/js/jquery.flexisel.js')}}></script>
	<script>
		$(window).load(function () {
	...
	<script src={{URL::asset('source/js/bootstrap.js')}}></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
