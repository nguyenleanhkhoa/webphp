...
<body>
				...
				<ul>
					<li>
						<a class="play-icon popup-with-zoom-anim" href="#small-dialog1">
							<span class="fa fa-map-marker" aria-hidden="true"></span> Đia điểm </a>
					</li>
					<li>
					...
					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> 093 780 8578
					</li>
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Đăng ký ngay để băt đầu mua sắm. Bạn không có tài khoản?
							<a href="#" data-toggle="modal" data-target="#myModal2">
								Đăng ký ngay</a>
						</p>
						<form action="#" method="post">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Tham gia cùng chúng tôi! Hãy đăng ký tài khoản.
						</p>
						<form action="#" method="post">
							<div class="styled-input agile-styled-input-top">
						...
						<p>
							<a href="#">Đồng ý các điều khoản </a>
						</p>
					</div>
				</div>
			</div>
	...
	<div class="welcome">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Chào mừng tới Yến Sào Gia Bảo
		...
		<div class="container">
			...
			<div class="about-tp">
				...
				<div class="col-md-4 about-agileits-w3layouts-right">
					...
					<h4>Yến Sào Gia Bảo</h4>
					<p>Siêu thị bán thực phẩm yến đứng đầu thế giới </p>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
	...
	<div class="footer-top">
		<div class="container-fluid">
			<div class="col-xs-8 agile-leftmk">
				<h2>Lấy sản phẩm tại cửa hàng gần nhất</h2>
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							...
							<li>
								<a href="privacy.phpzq">Privacy Policy</a>
							</li>
						</ul>
					</div>
					<div class="col-xs-6 footer-grids">
